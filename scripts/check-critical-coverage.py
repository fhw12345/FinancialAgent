...
THRESHOLDS = {
    ...
    "src/models/model_decision.py": 95.0,
    "src/services/decision_policy/model_decision.py": 85.0,
    "src/services/decision_policy/model_decision_gate.py": 90.0,
    "src/services/decision_policy/model_review.py": 85.0,
    "src/api/portfolio/model_decisions.py": 90.0,
