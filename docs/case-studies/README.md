...
| 2026-09-14 | [Hosted CI Needs Failure Proof](2026-09-14-hosted-ci-needs-failure-proof.md) | GitHub Actions / Compose / mypy / eval / Playwright | Runner compatibility, real negative gates, retained artifacts and enforced merge checks |
| 2026-09-09 | [Closeout Checklists Are Not Evidence](2026-09-09-closeout-checklists-are-not-evidence.md) | Docker / React / pytest / Playwright / CI | Markdown image regression, missing snapshot wiring, negative scanner controls, and honest publication blockers |
| 2026-08-13 | [Reproducible Builds Need Runtime Proof](2026-08-13-reproducible-builds-need-runtime-proof.md) | Docker / Python / npm / Playwright | Lock-preserving mirrors, semantic package-lock checks, non-root images, and fresh-image browser proof |
| 2026-08-12 | [Composition Tests Found Stale Failure After Success](2026-08-12-composition-tests-found-stale-success.md) | LangGraph / Portfolio / DataManager / pytest / Playwright | Real internal composition exposed stale retry state and an invalid failure-message source contract |
| 2026-08-06 | [Typed Boundaries Restored Frontend Lint Signal](2026-08-06-typed-boundaries-restored-lint-signal.md) | React / TypeScript / ESLint / SSE / Playwright | Runtime validation, zero-warning production lint, accessibility, and isolated test/E2E warning budgets |
| 2026-08-06 | [Strict Types Found Runtime Contract Failures](2026-08-06-strict-types-found-runtime-contracts.md) | Python / mypy / Pydantic / asyncio / MongoDB | 297 strict type errors exposed provider shape, cancellation, cache, mixin, and single-user migration runtime contracts |
| 2026-08-06 | [Green Tests Hid a Broken Shared-Data Contract](2026-08-06-green-tests-hidden-contract-drift.md) | FastAPI / DataManager / Docker / React / Playwright | Internal mocks hid a bad keyword while broad fallback disguised the programming error as provider degradation |
