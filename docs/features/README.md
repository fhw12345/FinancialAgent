...
- **[IDQ-001-C Model-Proposed Decisions](investment-model-decisions.md)** — in-progress; model gives explicit action/target per researched symbol, code validates without rewriting, human approves; never execution
