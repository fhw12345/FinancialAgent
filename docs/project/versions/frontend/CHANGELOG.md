...
- All 272 frontend tests, strict lint/types, 37 final-image scenarios, repeated builds and protected PR #14 CI pass; shipped as `0a9699d`. Live personal strategy remains unconfigured.
