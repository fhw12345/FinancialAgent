...
.PHONY: help dev build test eval test-e2e test-e2e-real test-e2e-uaw002 test-e2e-uaw003 test-e2e-uaw004 test-e2e-uaw005 test-e2e-uaw006 test-e2e-uaw007 test-e2e-uaw008 test-e2e-uaw009 test-e2e-uaw010 test-e2e-prompt-governance test-e2e-symbol-date-range test-e2e-chart-volume-overlay lint fmt clean up down logs copilot-reverse
