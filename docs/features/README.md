...
- **[IDQ-005 Strategy Contracts](investment-research-strategy-contracts.md)** — in-progress; approved fundamental pilot, explicit immutable assumptions and conditional calculators; mandate, horizon, valuation methods, and invalidation conditions
