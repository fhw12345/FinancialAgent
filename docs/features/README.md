...
- **[IDQ-001-C Model-Proposed Decisions](investment-model-decisions.md)** — shipped (0.59.0/0.40.0, PR #18); model gives explicit action/target per researched symbol, code validates without rewriting, human approves; never execution
