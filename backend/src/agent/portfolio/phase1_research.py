    ...
    async def _analyze_symbol(
        ...
        Args:
            ...
            suppress_chat: If True, skip per-symbol chat/message creation —
                ...
                inline on non-actionable decision assessments instead.
        ...
        try:
            ...
            from .research_prompt import render_research_prompt

            prompt = render_research_prompt(symbol, _phase1_language_directive())
            ...
            # A provider/agent error envelope is not symbol research. Do not
            # stringify it into a successful report that Phase 2 can cite.
            ...
            if not isinstance(response_text, str) or not response_text.strip():
                raise RuntimeError("Research execution returned no usable text")
