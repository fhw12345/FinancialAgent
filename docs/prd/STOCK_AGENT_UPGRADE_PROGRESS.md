...
| W2.3 | Translate Phase1 prompts to English | ✅ | (pending) | _phase1_language_directive() reads PHASE1_PROMPT_LANG env (defaults zh for back-compat). Setting `=en` switches output to English. 5 unit tests verify both modes + fallback. |
